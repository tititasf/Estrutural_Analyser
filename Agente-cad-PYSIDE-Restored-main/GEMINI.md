# GEMINI.md — ponteiro fixo (não editar; manter 1 fonte só)

> 1. **Fonte única do projeto: `CLAUDE.md`** — leia integralmente antes de agir.
> 2. Invariantes resumidos para agentes: `AGENTS.md` (este diretório).
> 3. Regras comportamentais de todos os agentes: `.agents/AGENTS.md`.
> Em conflito: CLAUDE.md > AGENTS.md > este arquivo.
