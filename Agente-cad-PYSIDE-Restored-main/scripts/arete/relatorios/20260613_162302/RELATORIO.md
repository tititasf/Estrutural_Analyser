...
- **G2 FAIL** — ent=10 geom=2 txt=8
  ...
  - `ABCD/painel`: ref=71 n4=13
  - `ABCD`: 79.5% divergência
  - `CIMA`: 53.8% divergência

### P26
- **G2 FAIL** — ent=8 geom=2 txt=14
  - `ABCD` texto extra em N4: "P26.A"
  - `ABCD` texto extra em N4: "P26.B"
  - `CIMA` texto ausente em N4: "2 sar"
  - `CIMA` texto ausente em N4: "2 sar"
  - `CIMA` texto ausente em N4: "5 sar"
  - `ABCD/chapa`: ref=0 n4=1
  - `ABCD/hachura`: ref=2 n4=0
  - `ABCD/painel`: ref=52 n4=13
  - `ABCD`: 82.6% divergência
  - `CIMA`: 70.0% divergência
...
- **G2 FAIL** — ent=9 geom=2 txt=24
  ...
  - `ABCD/painel`: ref=198 n4=13
  - `ABCD`: 79.3% divergência
  - `CIMA`: 92.0% divergência

## Próxima ação
Atacar G2-FAIL em P18: texto ausente em N4 na parte `ABCD`: "CAMBOTA".

_Gerado em 20260613_162302 — Arete Quality Gates_