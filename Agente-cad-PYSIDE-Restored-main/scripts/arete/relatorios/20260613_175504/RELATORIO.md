...
**Rodada:** 20260613_175504

## Resultado: 10P / 12F / 0B  |  Arete 45.5%
...
| P20 | PASS | PASS | FAIL | ✗ FAIL |  |
| P21 | PASS | PASS | FAIL | ✗ FAIL |  |
...
- **G2 FAIL** — ent=9 geom=2 txt=2
  - `ABCD` texto ausente em N4: "PD:3.12"
  - `ABCD` texto extra em N4: "PD:3.23"
  - `ABCD/chapa`: ref=0 n4=1
  - `ABCD/painel`: ref=40 n4=13
  - `ABCD/perfil`: ref=0 n4=1
...
_Gerado em 20260613_175504 — Arete Quality Gates_