...
for b in beam_labels:
    if b['text'].strip() == 'V306':
        pos = b['pos']
        lines = bt._capture_geometry(pos, orientations['V306'], orientations, beam_labels, 'V306')
        geo = bt._process_beam_geometry(pos, lines, orientations['V306'])
