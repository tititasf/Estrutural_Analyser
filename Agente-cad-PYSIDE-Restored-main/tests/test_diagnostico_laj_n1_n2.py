...
from scripts.arete.diagnostico_laj_n1_n2 import classify_delta, run_diagnostic
...
def _create_db(path: Path) -> None:
    ...
    rows = [
        (1, "Obra_TESTE", "13_PAV", "LAJ", "L301",
         json.dumps({"comprimento": 100.0, "largura": 50.0}), "draft", 0.9),
        (2, "Obra_TESTE", "13_PAV", "LAJ", "L318",
         json.dumps({"comprimento": 2413.0, "largura": 152.0}), "draft", 0.9),
