...
old_def = '    def _flush_attention_pending(self):'

new_def = '''    def _on_save_sa_clicked(self):
...
if old_def in content:
    ...
    print('Sucesso injetando o _on_save_sa_clicked!')
else:
    print('Metodo _flush_attention_pending nao encontrado!')
