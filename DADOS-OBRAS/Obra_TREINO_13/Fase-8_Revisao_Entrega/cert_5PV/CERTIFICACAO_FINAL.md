# Certificação CAD-ANALYZER — Obra_TREINO_13

**Pavimento:** 5PV  
**Pipeline:** CAD-ANALYZER v4.0  
**Timestamp:** 2026-05-22T15:43:59.390287+00:00  
...
| `C3_assembly_grade` | Assembly grade_1 >= 72% | 37.5 | ❌ FAIL | WARN |
| `C4_dxf_individual` | DXF individual PASS | - | ✅ PASS | WARN |
| `C5_dxf_coletivo` | DXF coletivo score >= 95% | 100.0 | ✅ PASS | BLOCK |
| `C6_fidelidade` | Fidelidade estrutural >= 50/100 | 85.6 | ✅ PASS | WARN |
