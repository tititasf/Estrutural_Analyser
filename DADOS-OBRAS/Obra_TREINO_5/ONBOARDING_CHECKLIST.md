# Checklist de Onboarding — Obra_TREINO_5

**Criado em:** 2026-04-30T18:15:40.517226+00:00
**Obra path:** D:\Agente-cad-PYSIDE\DADOS-OBRAS\Obra_TREINO_5

## 1. DXFs (verificação automática)

| Tipo | Arquivo | Status |
|------|---------|--------|
| PL | NOVA-D´URSO-EMBRAMACO-1PV-PL-R02_R2018_ASCII_ODA.dxf | ✅ |
| LV | NOVA-D´URSO-EMBRAMACO-1PV-LV-R00_R2018_ASCII_ODA.dxf | ✅ |
| FV | NOVA-D´URSO-EMBRAMACO-1PV-FV-R01_R2018_ASCII_ODA.dxf | ✅ |
| LJ | — | ❌ AUSENTE |
| EVG | — | ⏭️ opcional |
...
python scripts/cad_pipeline_cli.py run --obra DADOS-OBRAS/Obra_TREINO_5
