# Checklist de Onboarding — Obra_TREINO_18

**Criado em:** 2026-04-30T18:15:39.267937+00:00
**Obra path:** D:\Agente-cad-PYSIDE\DADOS-OBRAS\Obra_TREINO_18

## 1. DXFs (verificação automática)

| Tipo | Arquivo | Status |
|------|---------|--------|
| PL | ZAMBETA - LUXOR - 1PV - PL - R00 - 1°ETAPA_R2018_ASCII_ODA.dxf | ✅ |
| LV | ZAMBETA - LUXOR - 1PV - LV - R00 - 1°ETAPA_R2018_ASCII_ODA.dxf | ✅ |
| FV | ZAMBETA - LUXOR - 1PV - FV - R00 - 1°ETAPA_R2018_ASCII_ODA.dxf | ✅ |
| LJ | ZAMBETA - LUXOR - 1PV - LJ - R00 - 1°ETAPA_R2018_ASCII_ODA.dxf | ✅ |
| EVG | — | ⏭️ opcional |
...
python scripts/cad_pipeline_cli.py run --obra DADOS-OBRAS/Obra_TREINO_18
