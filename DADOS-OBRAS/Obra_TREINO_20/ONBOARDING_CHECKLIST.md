# Checklist de Onboarding — Obra_TREINO_20

**Criado em:** 2026-04-30T18:15:40.094694+00:00
**Obra path:** D:\Agente-cad-PYSIDE\DADOS-OBRAS\Obra_TREINO_20

## 1. DXFs (verificação automática)

| Tipo | Arquivo | Status |
|------|---------|--------|
| PL | NOVA-UNITÁ-ITAQUERA III-1PV-PL-R00_R2018_ASCII_ODA.dxf | ✅ |
| LV | — | ❌ AUSENTE |
| FV | — | ❌ AUSENTE |
| LJ | — | ❌ AUSENTE |
| EVG | — | ⏭️ opcional |
...
python scripts/cad_pipeline_cli.py run --obra DADOS-OBRAS/Obra_TREINO_20
