# Certificação CAD-ANALYZER — Obra_TREINO_3

**Pavimento:** TÉRREO - PERIFERIA - TORRE 1 - S02A  
**Pipeline:** CAD-ANALYZER v4.0  
**Timestamp:** 2026-05-22T16:14:37.527493+00:00  
...
| `C3_assembly_grade` | Assembly grade_1 >= 72% | 100.0 | ✅ PASS | WARN |
| `C4_dxf_individual` | DXF individual PASS | - | ✅ PASS | WARN |
| `C5_dxf_coletivo` | DXF coletivo score >= 95% | 100.0 | ✅ PASS | BLOCK |
| `C6_fidelidade` | Fidelidade estrutural >= 50/100 | 81.1 | ✅ PASS | WARN |
