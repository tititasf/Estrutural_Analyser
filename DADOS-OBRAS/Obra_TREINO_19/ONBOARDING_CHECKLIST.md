# Checklist de Onboarding — Obra_TREINO_19

**Criado em:** 2026-04-30T18:15:39.658233+00:00
**Obra path:** D:\Agente-cad-PYSIDE\DADOS-OBRAS\Obra_TREINO_19

## 1. DXFs (verificação automática)

| Tipo | Arquivo | Status |
|------|---------|--------|
| PL | QUATTRI - INDIANOPOLIS - 1° SUBOLO - PL - PROJEÇÃO - R00_R2018_ASCII_ODA.dxf | ✅ |
| LV | QUATTRI - INDIANOPOLIS - 1° SUBOLO - LV - PROJEÇÃO - R00_R2018_ASCII_ODA.dxf | ✅ |
| FV | QUATTRI - INDIANOPOLIS - 1° SUBOLO - FV - PROJEÇÃO - R00_R2018_ASCII_ODA.dxf | ✅ |
| LJ | QUATTRI - INDIANOPOLIS - 1° SUBOLO - LJ - PROJEÇÃO - R00_R2018_ASCII_ODA.dxf | ✅ |
| EVG | — | ⏭️ opcional |
...
python scripts/cad_pipeline_cli.py run --obra DADOS-OBRAS/Obra_TREINO_19
