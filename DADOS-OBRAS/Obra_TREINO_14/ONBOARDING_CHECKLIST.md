# Checklist de Onboarding — Obra_TREINO_14

**Criado em:** 2026-04-30T18:15:38.024955+00:00
**Obra path:** D:\Agente-cad-PYSIDE\DADOS-OBRAS\Obra_TREINO_14

## 1. DXFs (verificação automática)

| Tipo | Arquivo | Status |
|------|---------|--------|
| PL | NOVA-STOG-ARRAIA-1PV-PLC-R00_R2018_ASCII_ODA.dxf | ✅ |
| LV | — | ❌ AUSENTE |
| FV | NOVA-STOG-ARRAIA-1PAV-FV-R00_R2018_ASCII_ODA.dxf | ✅ |
| LJ | — | ❌ AUSENTE |
| EVG | — | ⏭️ opcional |
...
python scripts/cad_pipeline_cli.py run --obra DADOS-OBRAS/Obra_TREINO_14
