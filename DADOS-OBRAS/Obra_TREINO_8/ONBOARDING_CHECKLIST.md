# Checklist de Onboarding — Obra_TREINO_8

**Criado em:** 2026-04-30T18:15:40.927484+00:00
**Obra path:** D:\Agente-cad-PYSIDE\DADOS-OBRAS\Obra_TREINO_8

## 1. DXFs (verificação automática)

| Tipo | Arquivo | Status |
|------|---------|--------|
| PL | P4 - CASA 8 - IONEJI - T1 - 1º PAV. - PL - R00_R2018_ASCII_ODA.dxf | ✅ |
| LV | P4 - CASA 8 - IONEJI - T1 - 1°PAV - LV - R00_R2018_ASCII_ODA.dxf | ✅ |
| FV | P4 - CASA 8 - IONEJI - T1 - 1°PAV - FV - R00_R2018_ASCII_ODA.dxf | ✅ |
| LJ | P4 - CASA 8 - IONEJI - T1 - 1°PAV - LJ - R00_R2018_ASCII_ODA.dxf | ✅ |
| EVG | — | ⏭️ opcional |
...
python scripts/cad_pipeline_cli.py run --obra DADOS-OBRAS/Obra_TREINO_8
