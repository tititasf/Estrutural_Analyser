        ...
        if parede_uniao_selecionada_valor and abertura_viga_largura and abertura_viga_altura:
            try:
                ...
                if abertura_viga_largura > 0 and abertura_viga_altura > 0:
                    ...
                    script.append(f"{x_retangulo + abertura_viga_largura + 20},{y_retangulo - abertura_viga_altura/2 + float(altura_laje_entry.get() or 0)/2 + 5}")  # Ajuste para +5
                    script.append("")
                    script.append(";")
                    ...
                    script.append(f"{x_retangulo + (abertura_viga_largura - 15.5)/2},{y_retangulo - abertura_viga_altura + 5}")  # Ajuste para +5
                    script.append("")
                    script.append(";")
