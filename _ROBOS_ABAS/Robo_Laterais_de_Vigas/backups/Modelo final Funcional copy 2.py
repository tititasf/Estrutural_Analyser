...
def criar_script():
    ...
    try:
        ...
        if distancia_pilar and recorte_pilar:
            try:
                ...
                if distancia_pilar >= 0 and recorte_pilar > 0:
                    ...
                    script.append(f"{x_retangulo_1 + recorte_pilar/2},{y_cota_fundo + 5}")  # Ajuste para +5
                    script.append(";")
        ...
        # Verificar qual parede/união est�� selecionada
        parede_uniao_selecionada_valor = parede_uniao_selecionada.get()

        # Obter valores dos campos de abertura da viga 2
        ...
        # Verificar qual parede/união está selecionada para a abertura da viga 2
        parede_uniao_2_selecionada_valor = parede_uniao_2_selecionada.get()

        if parede_uniao_selecionada_valor and abertura_viga_largura and abertura_viga_altura and \
           parede_uniao_2_selecionada_valor and abertura_viga_2_largura and abertura_viga_2_altura:
            try:
                abertura_viga_largura = float(abertura_viga_largura)
                abertura_viga_altura = float(abertura_viga_altura)

                abertura_viga_2_largura = float(abertura_viga_2_largura)
                abertura_viga_2_altura = float(abertura_viga_2_altura)

                if abertura_viga_largura > 0 and abertura_viga_altura > 0 and \
                   abertura_viga_2_largura > 0 and abertura_viga_2_altura > 0:
                    ...
                    # Calcular coordenadas do retângulo com base na parede/união selecionada para a abertura da viga 2
                    parede_uniao_2_selecionada_index = int(parede_uniao_2_selecionada_valor)
                    if parede_uniao_2_selecionada_index == 0:
                        x_retangulo_2 = x_inicial
                    else:
                        x_retangulo_2 = x_inicial + sum(larguras_paineis[:parede_uniao_2_selecionada_index])

                    y_retangulo_2 = y_paineis[-1] + alturas_paineis[-1]  # Topo do painel mais alto
                    ...
                    # Somar 15.5 à largura da abertura da viga 2
                    abertura_viga_2_largura += 15.5

                    # Somar 12.2 à altura da abertura da viga 2 e subtrair a altura da laje
                    abertura_viga_2_altura += 2.2
                    abertura_viga_2_altura -= float(altura_laje_entry.get() or 0)
                    ...
                    # Adicionar comando de zoom antes de desenhar a abertura da viga 2
                    script.append("_ZOOM")
                    script.append("W")
                    script.append(f"{x_retangulo_2 - 10},{y_retangulo_2 + 10}")  # Canto superior esquerdo
                    script.append(f"{x_retangulo_2 + abertura_viga_2_largura + 10},{y_retangulo_2 - abertura_viga_2_altura - 10}")  # Canto inferior direito
                    script.append(";")
                    ...
                    script.append("_DIMLINEAR")
                    script.append(f"{x_retangulo + abertura_viga_largura - 15.5},{y_retangulo}")
                    script.append(f"{x_retangulo + abertura_viga_largura - 15.5},{y_retangulo - abertura_viga_altura + 2.2}")
                    script.append(f"{x_retangulo + abertura_viga_largura - 20},{y_retangulo - abertura_viga_altura/2 + 1.1}")  # Ajuste para -20 e +1.1
                    script.append("")
                    script.append(";")
                    ...
                    script.append(f"{x_retangulo + (abertura_viga_largura - 15.5)/2},{y_retangulo - abertura_viga_altura - 20}")  # Ajuste para -20
                    script.append("")
                    script.append(";")

                    # Adicionar cota da largura da abertura da viga 2 (à direita)
                    script.append("_DIMLINEAR")
                    script.append(f"{x_retangulo_2 + abertura_viga_2_largura - 15.5},{y_retangulo_2}")
                    script.append(f"{x_retangulo_2 + abertura_viga_2_largura - 15.5},{y_retangulo_2 - abertura_viga_2_altura + 2.2}")
                    script.append(f"{x_retangulo_2 + abertura_viga_2_largura - 20},{y_retangulo_2 - abertura_viga_2_altura/2 + 1.1}")  # Ajuste para -20 e +1.1
                    script.append("")
                    script.append(";")

                    # Adicionar cota da altura da abertura da viga 2 (abaixo)
                    script.append("_DIMLINEAR")
                    script.append(f"{x_retangulo_2},{y_retangulo_2 - abertura_viga_2_altura}")
                    script.append(f"{x_retangulo_2 + abertura_viga_2_largura - 15.5},{y_retangulo_2 - abertura_viga_2_altura}")
                    script.append(f"{x_retangulo_2 + (abertura_viga_2_largura - 15.5)/2},{y_retangulo_2 - abertura_viga_2_altura - 20}")  # Ajuste para -20
                    script.append(";")
                    ...
                    # Adicionar comandos para desenhar os retângulos das aberturas das vigas com avvsl2
                    ...
                    script.append(f"{x_retangulo_2},{y_retangulo_2}")
                    script.append(f"{x_retangulo_2 + abertura_viga_2_largura},{y_retangulo_2 - abertura_viga_2_altura}")
                    script.append(";")

                    # Adicionar zoom de distanciamento de 150 após desenhar as aberturas de viga
                    script.append("_ZOOM")
                    script.append("0.01")
                    script.append(";")
        ...
        # Obter valores dos campos do segundo pilar
        ...
        if distancia_pilar_2 and recorte_pilar_2:
            try:
                distancia_pilar_2 = float(distancia_pilar_2)
                recorte_pilar_2 = float(recorte_pilar_2)

                if distancia_pilar_2 >= 0 and recorte_pilar_2 > 0:
                    # Calcular coordenadas do retângulo para o segundo pilar
                    x_retangulo_1_2 = x_inicial + distancia_pilar_2
                    y_retangulo_1_2 = y_paineis[-1] + alturas_paineis[-1]  # Topo do painel mais alto
                    
                    x_retangulo_2_2 = x_retangulo_1_2 + recorte_pilar_2
                    y_retangulo_2_2 = y_paineis[0]  # Fundo do primeiro painel
                    
                    # Adicionar comandos para desenhar o retângulo com appv para o segundo pilar
                    script.append(";")
                    script.append("_ZOOM")
                    script.append("W")
                    script.append(f"{x_retangulo_1_2-10},{y_retangulo_1_2+10}")  # Canto superior esquerdo
                    script.append(f"{x_retangulo_2_2+10},{y_retangulo_2_2-10}")  # Canto inferior direito
                    script.append(";")
                    script.append("appv")
                    ...
                    # Adicionar comandos para desenhar o retângulo com apv2 para o segundo pilar
                    script.append(";")
                    script.append("_ZOOM")
                    script.append("W")
                    script.append(f"{x_retangulo_1_2-10},{y_retangulo_1_2+10}")  # Canto superior esquerdo
                    ...
                    # Posicionar a cota do fundo da abertura do segundo pilar abaixo do fundo dos painéis de altura 1
                    y_cota_fundo_2 = y_paineis[0]  # Alinhado com o fundo dos painéis de altura 1
                    script.append("_DIMLINEAR")
                    script.append(f"{x_retangulo_1_2},{y_cota_fundo_2}")
                    script.append(f"{x_retangulo_1_2 + recorte_pilar_2},{y_cota_fundo_2}")
                    script.append(f"{x_retangulo_1_2 + recorte_pilar_2/2},{y_cota_fundo_2 + 5}")  # Ajuste para +5
                    script.append(";")

                    # Adicionar zoom de distanciamento de 150 após desenhar o segundo pilar
                    script.append("_ZOOM")
                    script.append("0.01")
                    script.append(";")
