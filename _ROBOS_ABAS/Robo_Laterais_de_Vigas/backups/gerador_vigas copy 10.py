...
def criar_script():
    ...
    try:
        ...
        distancia_pilar = float(distancia_pilar_entry.get() or 0)
        recorte_pilar = float(recorte_pilar_entry.get() or 0)
...
# Adicionar campos de entrada para a distância do pilar e recorte do pilar
ttk.Label(main_frame, text="Distância do Pilar Esquerda:").grid(row=10, column=0, sticky="w")
distancia_pilar_entry = ttk.Entry(main_frame, width=20)
distancia_pilar_entry.grid(row=10, column=1, sticky="w")

ttk.Label(main_frame, text="Recorte Pilar largura:").grid(row=11, column=0, sticky="w") 
recorte_pilar_entry = ttk.Entry(main_frame, width=20)
recorte_pilar_entry.grid(row=11, column=1, sticky="w")
