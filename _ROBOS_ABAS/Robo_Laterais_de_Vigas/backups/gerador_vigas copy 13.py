...
def criar_script():
    ...
    try:
        ...
        atualizar_status(f"Script gerado com sucesso: {nome_arquivo}")
        return True
...
# Botão gerar
ttk.Button(main_frame, text="Gerar Script", command=gerar_script).grid(row=1, column=0, columnspan=2, pady=10)

# Botão Conectar AutoCAD
ttk.Button(main_frame, text="Conectar AutoCAD", command=conectar_autocad).grid(row=1, column=0, pady=10)

# Botão Executar Comandos
ttk.Button(main_frame, text="Executar Comandos", command=executar_comandos).grid(row=1, column=1, pady=10)
