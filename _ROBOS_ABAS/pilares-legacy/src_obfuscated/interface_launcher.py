...
import sys
try:
    from .utils.funcoes_auxiliares import calcular_aberturas_em_pares, processar_lado_a, processar_lado_b, classificar_linhas_por_lado
except ImportError:
    try:
        from utils.funcoes_auxiliares import calcular_aberturas_em_pares, processar_lado_a, processar_lado_b, classificar_linhas_por_lado
    except ImportError:
...
try:
    from .utils.funcoes_auxiliares_5 import GradeParafusosMixin
except ImportError:
    try:
        from utils.funcoes_auxiliares_5 import GradeParafusosMixin
    except ImportError:
...
if __name__ == "__main__":
    ...
    module_path = os.path.join(utils_dir, "funcoes_auxiliares_2.py")
    
    # Adicionar utils_dir ao path para permitir imports
    ...
    try:
        ...
        try:
            from utils import funcoes_auxiliares_3
        except ImportError:
