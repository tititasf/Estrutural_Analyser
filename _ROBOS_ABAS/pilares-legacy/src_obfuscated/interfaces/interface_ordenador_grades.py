...
# Importar Ordenador_Cordenadas_grades com múltiplos fallbacks
try:
    from ..robots.Ordenador_Cordenadas_grades import ProcessadorCoordenadasGrade, atualizar_comando_pilar_grade
except ImportError:
    try:
        from robots.Ordenador_Cordenadas_grades import ProcessadorCoordenadasGrade, atualizar_comando_pilar_grade
    except ImportError:
        try:
            from src.robots.Ordenador_Cordenadas_grades import ProcessadorCoordenadasGrade, atualizar_comando_pilar_grade
        except ImportError:
            try:
                ...
                import subprocess
                ProcessadorCoordenadasGrade = None
                atualizar_comando_pilar_grade = None

class ConfiguracaoOrdenadorGrade:
    def __init__(self):
        ...
        self.config_file = Path(project_root) / "config" / "configuracao_ordenador_GRADE.json"
...
class JanelaConfiguracaoGrade:
    def __init__(self, parent, config_manager):
        self.janela = tk.Toplevel(parent)
        self.janela.title("Configurações do Ordenador GRADE")
        self.janela.geometry("500x600")
        self.config_manager = config_manager
        
        # Recarregar configuração para refletir templates salvos dinamicamente
        print("[CONFIGURAÇÃO] Recarregando configuração GRADE para refletir templates salvos")
...
class InterfaceOrdenadorGrade:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("Ordenador de Coordenadas GRADE")
        self.root.geometry("400x250")
        
        self.config_manager = ConfiguracaoOrdenadorGrade()
        ...
        # Título
        ttk.Label(frame_principal, text="Ordenador de Coordenadas GRADE", font=("Arial", 14, "bold")).grid(row=0, column=0, pady=10)
    ...
    def selecionar_pasta(self):
        ...
        if pasta:
            ...
            try:
                ...
                atualizar_comando_pilar_grade(pasta)
    ...
    def abrir_configuracoes(self):
        JanelaConfiguracaoGrade(self.root, self.config_manager)
